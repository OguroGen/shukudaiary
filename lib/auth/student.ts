...
import { StudentLoginCredentials, StudentToken } from '@/types/student'
...
): Promise<{ student_id: string; nickname: string } | null> {
...
export function generateStudentToken(studentId: string): StudentToken {
...
export function validateStudentToken(token: string): string | null {
  try {
